...
print('Estimated number of clusters: %d(eps=.3; min=2)' % n_clusters_)
...
plt.xlim([-5,4])
plt.ylim([-5,5])
plt.title('Estimated number of clusters: %d (eps=.3; min=2)' % n_clusters_)
plt.savefig('eps=0.3; min_sample=2.jpg')
plt.show()
...
plt.ylim([-2.5, 0])
plt.title('Estimated number of clusters: %d (eps=.3; min=2)' % n_clusters_)
plt.savefig('eps=0.3; min_sample=2_zoomed_in.v1.jpg')
plt.show()
...
plt.ylim([-2,-1])
plt.title('Estimated number of clusters: %d (eps=.3; min=2)' % n_clusters_)
plt.savefig('eps=0.3; min_sample=2_zoomed_in.v2.jpg')
plt.show()